Public Class frmEditor_Animation
    ...
    Private Sub scrlSprite0_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles scrlSprite0.ValueChanged, scrlSprite0.Scroll
        lblSprite0.Text = "Sprite: " & scrlSprite0.Value
        Animation(EditorIndex).Sprite(0) = scrlSprite0.Value
    End Sub

    Private Sub scrlSprite1_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles scrlSprite1.ValueChanged, scrlSprite1.Scroll
        lblSprite1.Text = "Sprite: " & scrlSprite1.Value
        Animation(EditorIndex).Sprite(1) = scrlSprite1.Value
    End Sub

    Private Sub scrlLoopCount0_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles scrlLoopCount0.ValueChanged
        lblLoopCount0.Text = "Loop Count: " & scrlLoopCount0.Value
        Animation(EditorIndex).LoopCount(0) = scrlLoopCount0.Value
    End Sub

    Private Sub scrlLoopCount1_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles scrlLoopCount1.ValueChanged, scrlLoopCount1.Scroll
        lblLoopCount1.Text = "Loop Count: " & scrlLoopCount1.Value
        Animation(EditorIndex).LoopCount(1) = scrlLoopCount1.Value
    End Sub

    Private Sub scrlFrameCount0_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles scrlFrameCount0.ValueChanged
        lblFrameCount0.Text = "Frame Count: " & scrlFrameCount0.Value
        Animation(EditorIndex).Frames(0) = scrlFrameCount0.Value
    End Sub

    Private Sub scrlFrameCount1_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles scrlFrameCount1.ValueChanged
        lblFrameCount1.Text = "Frame Count: " & scrlFrameCount1.Value
        Animation(EditorIndex).Frames(1) = scrlFrameCount1.Value
    End Sub

    Private Sub scrlLoopTime0_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles scrlLoopTime0.ValueChanged
        lblLoopTime0.Text = "Loop Time: " & scrlLoopTime0.Value
        Animation(EditorIndex).looptime(0) = scrlLoopTime0.Value
    End Sub

    Private Sub scrlLoopTime1_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles scrlLoopTime1.ValueChanged

...
Module modDataBase
    ...
    Public Sub LoadOptions()
        ...
        Else
            ...
            Options.SavePass = CBool(Getvar(FileName, "Options", "SavePass"))
        ...
        If Options.Music = 0 Then
            'frmMainGame.optMOff.Value = True
        Else
            'frmMainGame.optMOn.Value = True
        End If

        If Options.Sound = 0 Then
            'frmMainGame.optSOff.Value = True
        Else
            'frmMainGame.optSOn.Value = True
        End If
    End Sub

    ...
    Public Sub SendMap()
        ...
        For X = 0 To Map.MaxX
            For Y = 0 To Map.MaxY
                ...
                '    Buffer.WriteLong(Map.exTile(X, Y).Layer(i).tileset)
                '    Buffer.WriteLong(Map.exTile(X, Y).Layer(i).X)
                '    Buffer.WriteLong(Map.exTile(X, Y).Layer(i).Y)
                '    Buffer.WriteLong(Map.exTile(X, Y).Autotile(i))
                'Next
            Next
        Next

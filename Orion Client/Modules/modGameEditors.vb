...
Module modGameEditors
    ...
    Public Sub MapEditorChooseTile(ByVal Button As Integer, ByVal X As Single, ByVal Y As Single)
        ...
        If Button = MouseButtons.Left Then 'Left Mouse Button
            ...
            EditorTileSelEnd = New Point(EditorTileX + 1, EditorTileY + 1)
        End If
    ...
    Public Sub MapEditorMouseDown(ByVal Button As Integer, ByVal X As Long, ByVal Y As Long, Optional ByVal movedMouse As Boolean = True)
        ...
        If Button = MouseButtons.Left Then
            If frmEditor_Map.optLayers.Checked = True Then
                If (EditorTileSelEnd.X - EditorTileSelStart.X) = 1 And (EditorTileSelEnd.Y - EditorTileSelStart.Y) = 1 Then 'single tile
    ...
    Public Sub MapEditorSetTile(ByVal X As Long, ByVal Y As Long, ByVal CurLayer As Long, Optional ByVal multitile As Boolean = False)
        ...
        Else ' multitile
            ...
            For Y = CurY To CurY + (EditorTileSelEnd.Y - EditorTileSelStart.Y) - 1
                x2 = 0 ' re-set x count every y loop
                For X = CurX To CurX + (EditorTileSelEnd.X - EditorTileSelStart.X) - 1

...
Partial Class frmEditor_Classes
    ...
    Friend WithEvents btnItemAdd As Windows.Forms.Button
    Friend WithEvents Label4 As Windows.Forms.Label
    Friend WithEvents numItemAmount As Windows.Forms.NumericUpDown
    Friend WithEvents Label3 As Windows.Forms.Label
    Friend WithEvents cmbItems As Windows.Forms.ComboBox
    Friend WithEvents lstStartItems As Windows.Forms.ListBox
    Friend WithEvents Label1 As Windows.Forms.Label
    Friend WithEvents txtName As Windows.Forms.TextBox
    Friend WithEvents scrlFemaleSprite As Windows.Forms.HScrollBar
    Friend WithEvents scrlMaleSprite As Windows.Forms.HScrollBar
    ...
    Friend WithEvents numStrength As Windows.Forms.NumericUpDown
    Friend WithEvents numVitality As Windows.Forms.NumericUpDown
    Friend WithEvents Label6 As Windows.Forms.Label
    Friend WithEvents numEndurance As Windows.Forms.NumericUpDown
    Friend WithEvents Label5 As Windows.Forms.Label
    Friend WithEvents numSpirit As Windows.Forms.NumericUpDown
    Friend WithEvents Label7 As Windows.Forms.Label
    Friend WithEvents numIntelligence As Windows.Forms.NumericUpDown
    Friend WithEvents Label8 As Windows.Forms.Label
    Friend WithEvents numLuck As Windows.Forms.NumericUpDown
    Friend WithEvents Label9 As Windows.Forms.Label
    Friend WithEvents GroupBox5 As Windows.Forms.GroupBox
    Friend WithEvents numStartY As Windows.Forms.NumericUpDown
    Friend WithEvents Label12 As Windows.Forms.Label
    Friend WithEvents numStartX As Windows.Forms.NumericUpDown
    Friend WithEvents Label11 As Windows.Forms.Label
    Friend WithEvents numStartMap As Windows.Forms.NumericUpDown
    Friend WithEvents Label10 As Windows.Forms.Label
    Friend WithEvents btnAddClass As Windows.Forms.Button
    Friend WithEvents btnRemoveClass As Windows.Forms.Button
    Friend WithEvents btnDeleteMaleSprite As Windows.Forms.Button
    Friend WithEvents btnAddMaleSprite As Windows.Forms.Button
    Friend WithEvents btnDeleteFemaleSprite As Windows.Forms.Button
    Friend WithEvents btnAddFemaleSprite As Windows.Forms.Button
    Friend WithEvents GroupBox7 As Windows.Forms.GroupBox
    Friend WithEvents cmbFemaleSprite As Windows.Forms.ComboBox
    Friend WithEvents GroupBox6 As Windows.Forms.GroupBox
    Friend WithEvents cmbMaleSprite As Windows.Forms.ComboBox

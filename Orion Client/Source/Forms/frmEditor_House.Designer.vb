...
Partial Class frmEditor_House
    ...
    Friend WithEvents txtHouseFurniture As Windows.Forms.TextBox
    Friend WithEvents Label5 As Windows.Forms.Label
    Friend WithEvents Label4 As Windows.Forms.Label
    Friend WithEvents Label3 As Windows.Forms.Label
    Friend WithEvents txtHousePrice As Windows.Forms.TextBox
    Friend WithEvents txtYEntrance As Windows.Forms.TextBox
    Friend WithEvents txtXEntrance As Windows.Forms.TextBox
    Friend WithEvents txtBaseMap As Windows.Forms.TextBox

...
#Region "Frm Code"
    ...
    Private Sub btnStart_Click(sender As Object, e As EventArgs) Handles btnStart.Click
        lblMapTime.Text = "Working..."
        lblPathTime.Text = "Loading..."
        lblRiversTime.Text = "Loading..."
        lblOvergrassTime.Text = "Loading..."
        lblMountainsTime.Text = "Loading..."
        lblResourcesTime.Text = "Loading..."
        lblCacheTime.Text = "Loading..."
        lblTime.Text = "Loading..."
        btnStart.Enabled = False
        DoEvents()
        StartAutomapper(Val(txtMapStart.Text), Val(txtMapSize.Text), Val(txtX.Text), Val(txtY.Text))

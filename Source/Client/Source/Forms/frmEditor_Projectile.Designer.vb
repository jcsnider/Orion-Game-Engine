...
Partial Class frmEditor_Projectile
    ...
    Friend WithEvents scrlPic As Windows.Forms.HScrollBar
    Friend WithEvents lblPic As Windows.Forms.Label
    Friend WithEvents picProjectile As Windows.Forms.PictureBox
    Friend WithEvents txtName As Windows.Forms.TextBox
    Friend WithEvents Label1 As Windows.Forms.Label
    Friend WithEvents scrlRange As Windows.Forms.HScrollBar
    Friend WithEvents lblRange As Windows.Forms.Label
    Friend WithEvents scrlDamage As Windows.Forms.HScrollBar
    Friend WithEvents lblDamage As Windows.Forms.Label
    Friend WithEvents scrlSpeed As Windows.Forms.HScrollBar
    Friend WithEvents lblSpeed As Windows.Forms.Label
